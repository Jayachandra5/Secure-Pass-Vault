...
public class FullTable {
    ...
    public void start(Stage stage) {
        ...
        Col1.setMinWidth((sceneWidth / 8));
        Col1.setCellValueFactory(
                new PropertyValueFactory<Person, String>("firstName"));

        TableColumn Col2 = new TableColumn("UserName");
        Col2.setMinWidth((sceneWidth / 8));
        Col2.setCellValueFactory(
                new PropertyValueFactory<Person, String>("lastName"));

        TableColumn Col3 = new TableColumn("Current Pass");
        Col3.setMinWidth((sceneWidth / 8));
        Col3.setCellValueFactory(
                new PropertyValueFactory<Person, String>("email"));

        TableColumn Col4 = new TableColumn("Prev Pass1");
        Col4.setMinWidth((sceneWidth / 8) - 15);
        Col4.setCellValueFactory(
                new PropertyValueFactory<Person, String>("Price"));

        TableColumn Col5 = new TableColumn("Prev Pass2");
        Col5.setMinWidth((sceneWidth / 8) - 15);
        Col5.setCellValueFactory(
                new PropertyValueFactory<Person, String>("five"));

        TableColumn Col6 = new TableColumn("Prev pass3");
        Col6.setMinWidth((sceneWidth / 8));
        Col6.setCellValueFactory(
                new PropertyValueFactory<Person, String>("six"));

        TableColumn Col7 = new TableColumn("Status");
        Col7.setMinWidth((sceneWidth / 8));
        Col7.setCellValueFactory(
                new PropertyValueFactory<Person, String>("seven"));

        TableColumn Col8 = new TableColumn("Url");
        Col8.setMinWidth((sceneWidth / 8));
        Col8.setCellValueFactory(
                new PropertyValueFactory<Person, String>("eight"));
    ...
    public static class Person {
        ...
        private Person(String fName, String lName, String email, String price, String five, String six, String seven, String eight) {
    ...
    public void getData() {
        ...
        try (Connection conn = Constants.getConnection()) {
            String query = "SELECT data.Appname, data.username, data.password, "
                    + "Oldpasswords.password1, Oldpasswords.password2, Oldpasswords.password3, "
                    + "data.status, data.url "
                    + "FROM data "
                    + "JOIN Oldpasswords ON data.Appname = Oldpasswords.appname "
                    + "WHERE data.currentUserName = ?";
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query)) {
                ...
                while (resultSet.next()) {
                    ...
                    if (hashPassword != null) {
                        password = hash.decrypt(hashPassword, "ThisIsASecretKey");
                    }
                    ...
                    data.add(new Person(appName, username, password, password1, password2, password3, status, url));
